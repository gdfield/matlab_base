function STA = compute_sta_binned(movie, spike_counts, num_frames_back, center_stimulus)
% COMPUTE_STA_BINNED Compute spike-triggered average from binned spike counts
%
% Inputs:
