...
% Month 2 Data
path_2m{1} = [serverpath, '2019-08-15-0/data005/data005'];
path_2m{2} = [serverpath, '2019-10-30-0/data005/data005'];
path_2m{3} = [serverpath, '2018-03-15-0/data004/data004'];
...
time_courses = [];
    ...
    for dset = 1:length(datarun_set)
        datarun_set{dset} = get_sta_summaries(datarun_set{dset}, cell_types{ct}, 'marks_params', marks_params);
