...
function[TCParams] = time_course_parameters(timecourse, correction, timevector)
...
TCParams.dot = abs(TCParams.area) ./ TCParams.areaabs; 
TCParams.pk_dot = abs(TCParams.minmaxadd) ./ TCParams.minmaxabsadd;
