...
% uncomment if spatial is really big


% GLMT.stimfilter_mode = 'fixedSP_rk1_linear'; GLMT.CONVEX = true;
% 'rk1' fits the spatial filter and 'fixedsp' uses the STA
GLMT.stimfilter_mode = 'rk1'; GLMT.CONVEX = false; 
% If you provide an STA make this fixedsp otherwise for LN it will use the 
% STA computed in the GLM fit first
...
GLMT.debug      = false; % makes it stop faster
...
GLMP.stimfilter.ROI_length = 13; % better if odd; pixels wide the movie is;  % This is the SIZE of the spatial filter in pixels
GLMP.stimfilter.frames = 30; % lower from 30 % This is the number of frames in the temporal filter
% GLMP.stimfilter.ROI_length = 17;  % This is the SIZE of the spatial filter in pixels %% Make this number ODD
...
GLMP.spikefilters.ps.bstretch     = 0.95; %%change from 0.05
