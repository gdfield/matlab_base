...
% make sure your timing and indexing is right. Use align_spikes_triggers.m.
%
% This also only works for greyscale movies! It is not set up for color!
%
% Check the model architecture in glm_parameters.m, and make sure you are
% using reasonable filter sizes etc. 
%
...
eval(['[GLMT, GLMP] = ' GLM_params ';']) % GLMType and GLMParams defined here
