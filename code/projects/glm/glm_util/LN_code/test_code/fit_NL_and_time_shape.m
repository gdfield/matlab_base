function [model, t_init, increments] = fit_NL_and_time_shape(fittedGLM, fitspikes, fitmovie, varargin)
...
for iter = 1:iterations
    ...
    new_time = fminunc(@(time_course)timecourse_error_function_test(time_course, firing_rate, model, gen_signal_spatial, 0), t_init);
