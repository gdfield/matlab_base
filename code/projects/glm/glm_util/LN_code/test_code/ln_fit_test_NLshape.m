function opt_model = ln_fit_test_NLshape(fitspikes, fitmovie, center, varargin)
%% DESCRIPTION
% NJB 2016-06-03
%
...
[model, time, iterations] = fit_NL_and_time_shape(fittedGLM, fitspikes, fitmovie, 'iterations', iterations);
