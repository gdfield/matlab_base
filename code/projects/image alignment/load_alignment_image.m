...
if nargin == 0
    alignment_image = {'pm32','pm10','pm2', 'pm20'};
    return
end
...
switch ai_type
    case 'pm'
        switch spec
            ...
            case 'pm20'  % BW white noise frame with 2 pixels/stixel
                image_path = [matlab_code_path 'code/projects/image alignment/images/photographic mapping 20 OLED.tif'];
                xdata = [1 800];  ydata = [101 700];
            otherwise
