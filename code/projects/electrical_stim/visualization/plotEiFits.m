...
%   printElectrodeNums: prints electrode numbers
%        plotEiScatter: default false, adds a scatter plot to represent
%                       each EI
%
%    Outputs:
...
for j=1:(nbin/2)
    ...
    switch lower(varargin{j*2-1})
        ...
        case 'printelectrodenums'
            printElectrodeNums = varargin{j*2};
        case 'ploteiscatter'
            plotEiScatter = varargin{j*2};
        otherwise
            err = MException('MATLAB:InvArgIn',...
