...
switch experiment_id
    case '2016-04-21-10'
        ...
        tubulin = imresize(im1(:,:,2),'OutputSize',[2000 NaN]); 
...
%% 2015-10-06-6 most perfect alignment
clear all; 
vasc_sm = imread('/Volumes/Analysis/2015-10-06-6/image analysis/bundle_paper_figures/vasc.tif');
alignment_image = imread('/Volumes/Data/2015-10-06-6/Imaging/vasculature_alignment_with_array/2015-10-06-6_stitched_sm.jpg');
% Choose the channel containing vasculature only.
arra_sm = alignment_image(650:5340,1045:9445,3);
% cpselect(vasc_sm, arra_sm);

load('/Volumes/Analysis/2015-10-06-6/image analysis/bundle_paper_figures/controlPoints.mat')
load('/Volumes/Analysis/2015-10-06-6/image analysis/bundle_paper_figures/electrode_coords.mat')
mytform_lwm = fitgeotrans(movingPts, fixedPts,'lwm',12);
r = imwarp(vasc_sm, mytform_lwm);
...
hold on;  scatter(newXYCoords(1,:),newXYCoords(2,:),30,[1 1 1], 'filled');
dapi_sm = imread('/Volumes/Analysis/2015-10-06-6/image analysis/bundle_paper_figures/dapi.tif');
tub_sm = imread('/Volumes/Analysis/2015-10-06-6/image analysis/bundle_paper_figures/tubulin.tif');
d = imwarp(dapi_sm, mytform_lwm);
t = imwarp(tub_sm, mytform_lwm);