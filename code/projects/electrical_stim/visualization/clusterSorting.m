...
% % Temp hack for analyzing Raphe piece 2016-02-17-3
% params_path = [dirname dirname(find(dirname == filesep,1,'last'):end) '.params'];
% paramFile = edu.ucsc.neurobiology.vision.io.ParametersFile(params_path);
% neuronIds = [paramFile.getNeuronsInClass('All/OFF/parasols'); paramFile.getNeuronsInClass('All/ON/parasols')]; 
