function [params]=InitializeArrayRobust(pathToPreparation,arrayObj,varargin)
% Optional inputs:
...
els=randsample(activeElecs,floor(length(activeElecs)/2));
els=activeElecs;
rhoUnique=rho(els);
...
%f1=@(Art,x)logDetKron(Arts(:,:,:),[x(1:7) -100 -100 x(8) log(var0)],Difs,setdiff([1:10],[8 9]),[1 1 1],Diags,[3 3 3]);
%f1=@(Art,x)logDetKron(Arts(:,:,:),[x(1:4) -100 -100 x(5) -100 -100 x(6) log(var0)],Difs,setdiff([1:10],[5 6 8 9]),[1 1 1],Diags,[3 3 3]);
f1=@(Art,x)logDetKron(Arts(:,:,:),[x(1) -100 -100 x(2) -100 -100 x(3) -100 -100 x(4) log(var0)],Difs,setdiff([1:10],[ 2 3 5 6 8 9]),[1 1 1],Diags,[3 3 3]);
...
x0(7)=-2;
x0(8)=10;
x1 = fminunc(g1,x0([[1 4],[7 8]]),options);
