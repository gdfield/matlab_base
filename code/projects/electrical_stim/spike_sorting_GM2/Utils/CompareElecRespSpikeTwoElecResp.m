function [Measures Activations thresH thresAlg  timesFN params onsets]=CompareElecRespSpikeTwoElecResp(elecResp,elecRespAuto,varargin)


neuron=elecResp.cells.main;
aux=elecResp.analysis.latencies;
[~,~,indexCollapse]=collapseAmplitudesEqual(elecResp.stimInfo.stimAmps,elecResp.stimInfo.stimAmps);
