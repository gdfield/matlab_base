...
% basepath          '/Volumes/Archive/' Where the images are stored
...
p.addParamValue('basepath','/Volumes/Archive/');
...
switch mapping_type
    case 'photographic'
        ...
        pm_image = imread([params.basepath '/' datarun.piece.(sprintf('photographic_mapping_%s',params.which_pm))]);
        ...
        pm_image = imread([params.basepath '/' datarun.piece.photographic_mapping_array_edges]);
