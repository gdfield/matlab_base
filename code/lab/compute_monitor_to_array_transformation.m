...
elseif strcmp(params.source, 'images')
    ...
    if isfield(datarun.piece.photographic_mapping,'points_base_to_array') && ...
        ...
        if params.reselect
            ...
            [xy_array_edges, xy_array] = cpselect(pm_images.photographic_mapping_array_edges,array.im(:,:,1:3),...
        ...
        [xy_array_edges, xy_array] = cpselect(pm_images.photographic_mapping_array_edges,array.im(:,:,1:3),'wait',true);
    end
...
datarun = copy_images_to_stacks(datarun, 'basepath', '/Archive/');
