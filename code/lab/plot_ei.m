function [elec_handles, ei] = plot_ei(datarun, cell_id, varargin)
...
[elec_handles, ei] = plot_ei_(get_ei(datarun,cell_id), positions, params.frame_number, p.Unmatched, 'stack_outline', outline);
