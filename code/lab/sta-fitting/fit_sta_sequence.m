...
temp_sta = sta;
    ...
    if fit_center
        ...
        if fit_temporal
            ...
            params.initial_n_one_filters = temp_fit.n_one_filters;
            params.initial_n_two_filters = temp_fit.n_two_filters;
        end
            ...
            params.fit_n_one_filters = false;
            params.fit_n_two_filters = false;
            params.verbose = verbose;
  ...
  % Use these above fit results as initial conditions and allow the entire fit to vary
    ...
    if fit_temporal
        ...
        params.fit_n_one_filters = true;
        params.fit_n_two_filters = true;
    end
