function datarun = load_java_movie(datarun, movie_xml_path, triggers, varargin)
...
if exist('movie_xml_path', 'var')
    ...
    the_stimulus = guess_stimulus(stimulus_from_java_movie(movie), 'display_type', p.Results.display_type);
